      ...
      <Card className="w-full max-w-md shadow-xl border-0 relative z-10">
        <div className="p-8">
          ...
          <div className="mt-6 flex items-center justify-between text-sm">
            <Link href="/forgot-password" className="text-secondary hover:text-secondary-dark transition-colors">
              Forgot Password?
            </Link>
            <Link href="/signup" className="text-secondary hover:text-secondary-dark transition-colors">
              Sign Up
            </Link>
          </div>
        </div>
